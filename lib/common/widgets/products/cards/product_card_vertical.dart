    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Stack(
            children: [
              BeatnikRoundedImage(imageUrl: imageUrl, applyImageRadius: true,),
            ],
          ),
          Padding(
              ...
              children: [
                ...
                Text(
                  ...
                  style: Theme.of(context).textTheme.bodySmall!.apply(
                      color:
                          dark ? BeatnikColors.grey : BeatnikColors.lightGrey),
                ),
                Row(
                  ...
                  children: [
                    Text(
                      ...
                      style: Theme.of(context)
                          .textTheme
                          .bodyLarge!
                          .apply(color: BeatnikColors.primary),
                    ),
